...
@section('pageTitle','Chemical Usage')
                    ...
                    <div class="col-12">
                        <table
                            ...
                            <tr>
                                    ...
                                    <th data-sortable="true" data-field="ChemicalName">ChemicalName</th>
                                    <th data-sortable="true" class='text-right' data-field="usage">Usage (gal)</th>
...
<script src="/js/chemical.min.js" ></script>
