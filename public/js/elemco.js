...
function tableDateFormatter(value, row, index) {
 ...
 function RoundFormatter2(value, row, index) {
...
/// https://hilmar.elemcointelligence.com/active?plant=Plant%202&equipment=HCV-11&line=CIP%2028  
  ...
  function getURLParameters() {
    ...
    for (var index=0; index < params.length; index++) {
        ...
        if(param.length == 2) {  // key=value / 2 parts
            paramList[param[0]] = decodeQueryParam(param[1]);
        }
    }
    return paramList;
 }
...
/*
function tableDateFormatter(cell) {
    if (!cell) {
          return "";
    }
